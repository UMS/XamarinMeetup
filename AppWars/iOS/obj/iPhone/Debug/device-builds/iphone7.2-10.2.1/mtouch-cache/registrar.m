...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "AppWars.iOS.AppDelegate, AppWars.iOS", "FinishedLaunching");
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_9 (self, _cmd, &managed_method, "AppWars.iOS.AppDelegate, AppWars.iOS", ".ctor", &call_super);
		if (call_super && rv) {
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "AppWars.iOS.AppDelegate, AppWars.iOS", NULL },
